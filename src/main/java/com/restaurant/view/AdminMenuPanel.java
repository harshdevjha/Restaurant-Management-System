...
public class AdminMenuPanel extends JPanel {
    ...
    private void deleteSelected() {
        ...
        if (confirm == JOptionPane.YES_OPTION) {
            if (MenuController.deleteItem(id))
                ...
                JOptionPane.showMessageDialog(this, "Could not delete item.", "Error",
    ...
    private void showItemDialog(MenuItem existing) {
        ...
        form.add(UITheme.createLabel("Category:", UITheme.FONT_BTN, UITheme.TEXT_DARK));
        form.add(catCombo);
        form.add(UITheme.createLabel("Name:", UITheme.FONT_BTN, UITheme.TEXT_DARK));
        form.add(nameField);
        form.add(UITheme.createLabel("Description:", UITheme.FONT_BTN, UITheme.TEXT_DARK));
        form.add(descField);
        form.add(UITheme.createLabel("Price (₹):", UITheme.FONT_BTN, UITheme.TEXT_DARK));
        form.add(priceField);
